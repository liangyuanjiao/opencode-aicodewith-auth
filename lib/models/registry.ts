...
export const MODELS: ModelDefinition[] = [
  ...
  },
  {
    ...
    modalities: { input: ["text", "image"], output: ["text"] },
    reasoning: "full",
    aliases: ["gpt-5.1-codex", "gpt 5.1 codex", "codex"],
  },
  {
    ...
    modalities: { input: ["text", "image"], output: ["text"] },
    reasoning: "xhigh",
    aliases: ["gpt-5.1-codex-max", "gpt 5.1 codex max", "codex-max"],
  },
  {
    ...
    modalities: { input: ["text", "image"], output: ["text"] },
    reasoning: "basic",
    aliases: ["gpt-5.1-codex-mini", "gpt 5.1 codex mini", "codex-mini-latest", "gpt-5-codex-mini"],
  },
  {
    id: "gpt-5.1",
    family: "gpt",
    ...
    modalities: { input: ["text", "image"], output: ["text"] },
    reasoning: "full",
    aliases: ["gpt-5.1", "gpt 5.1", "gpt-5", "gpt 5"],
  },
